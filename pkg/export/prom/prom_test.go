	...
	tests := []InstrTest{
		{
			...
			expected: []string{
				...
				"ebpf_cuda_kernel_launch_calls_total",
				"ebpf_cuda_graph_launch_calls_total",
				"ebpf_cuda_kernel_grid_size_total",
				"ebpf_cuda_kernel_block_size_total",
				"ebpf_cuda_memory_allocations_bytes_total",
				"ebpf_cuda_memory_copies_bytes_total",
			},
			unexpected: []string{},
		},
		{
